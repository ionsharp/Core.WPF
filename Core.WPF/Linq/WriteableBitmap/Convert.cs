...
namespace Imagin.Core.Linq
{
    ...
    public unsafe static partial class XBitmap
    {
      ...
      [Obsolete("Please use XBitmap.FromResource instead of this FromResource method.")]
      public static WriteableBitmap FromResource(this WriteableBitmap bmp, string relativePath)
      {
         return XBitmap.FromResource(relativePath);
      }
#endif
        ...
        /// <returns>A new WriteableBitmap containing the pixel data.</returns>
        [Obsolete("Please use XBitmap.FromContent instead of this FromContent method.")]
        ...
        {
            return XBitmap.FromContent(uri, pixelFormat);
        }
        ...
        /// <param name="pixelFormat">The pixel format of the stream data. If Unknown is provided as param, the default format of the BitmapDecoder is used.</param>
        /// <returns>A new WriteableBitmap containing the pixel data.</returns>
        [Obsolete("Please use XBitmap.FromStream instead of this FromStream method.")]
        ...
        {
            return XBitmap.FromStream(stream, pixelFormat);
        }
        ...
        /// <returns>A new WriteableBitmap containing the pixel data.</returns>
        [Obsolete("Please use XBitmap.FromPixelBuffer instead of this FromPixelBuffer method.")]
        public static Task<WriteableBitmap> FromPixelBuffer(this WriteableBitmap bmp, IBuffer pixelBuffer, int width, int height)
        {
            return XBitmap.FromPixelBuffer(pixelBuffer, width, height);
        }
#else
      /// <summary>
      /// Loads an image from the applications content and returns a new WriteableBitmap. The passed WriteableBitmap is not used.
      ...
      {
         return XBitmap.FromContent(relativePath);
      }
      ...
      {
         return XBitmap.FromStream(stream);
      }
#endif
