...
namespace Imagin.Core.Linq
{
    public unsafe static partial class XBitmap
    {
        ...
        /// <param name="color">The color for the line.</param>
        /// <param name="clipRect">The region in the image to restrict drawing to.</param>
        public static void DrawLine(Paint.BitmapContext context, int pixelWidth, int pixelHeight, int x1, int y1, int x2, int y2, int color, Rect? clipRect = null)
        {
            // Get clip coordinates
            int clipX1 = 0;
        ...
        public static void DrawLinePenned(this WriteableBitmap bmp, int x1, int y1, int x2, int y2, WriteableBitmap penBmp, Rect? clipRect = null)
        {
            using (var context = bmp.GetBitmapContext())
            {
                using (var penContext = penBmp.GetBitmapContext(Paint.ReadWriteMode.ReadOnly))
                {
        ...
        public static void DrawLinePenned(Paint.BitmapContext context, int w, int h, int x1, int y1, int x2, int y2, Paint.BitmapContext pen, Rect? clipRect = null)
        {
        ...
        private static void DrawVertically(Paint.BitmapContext context, int x, int y1, int y2, int dotSpace, int dotLength, int color) {
        ...
        private static void DrawHorizontally(Paint.BitmapContext context, int x1, int x2, int y, int dotSpace, int dotLength, int color) {
            int width = context.Width;
            int height = context.Height;
        ...
        private static void Draw(Paint.BitmapContext context, int x1, int y1, int x2, int y2, int dotSpace, int dotLength, int color) {
            // y = m * x + n
            // y - m * x = n
        ...
        /// <param name="sb">Premultiplied blue color component</param>
        /// <param name="clipRect">The region in the image to restrict drawing to.</param>
        public static void DrawLineWu(Paint.BitmapContext context, int pixelWidth, int pixelHeight, int x1, int y1, int x2, int y2, int sa, int sr, int sg, int sb, Rect? clipRect = null)
        {
            // Perform cohen-sutherland clipping if either point is out of the viewport
        ...
        /// </summary>
        public static void DrawLineAa(Paint.BitmapContext context, int pixelWidth, int pixelHeight, int x1, int y1, int x2, int y2, int color, int strokeThickness, Rect? clipRect = null)
        {
        ...
        /// <param name="strokeThickness">The stroke thickness of the line.</param>
        /// </summary>
        public static void DrawLineAa(Paint.BitmapContext context, int pixelWidth, int pixelHeight, int x1, int y1, int x2, int y2, Color color, int strokeThickness, Rect? clipRect = null)
        {
            var col = ConvertColor(color);
        ...
        /// <param name="color">The color for the line.</param>
        /// </summary> 
        public static void DrawLineAa(Paint.BitmapContext context, int pixelWidth, int pixelHeight, int x1, int y1, int x2, int y2, int color, Rect? clipRect = null)
        {
        ...
        private static void AlphaBlendNormalOnPremultiplied(Paint.BitmapContext context, int index, int sa, uint srb, uint sg)
        {
            var pixels = context.Pixels;
