...
{
    /// <summary>Executes a stream on actions on the dispatcher thread.</summary>
    internal class ConcurrentDispatcherQueue
    {
        #region Properties
        ...
        /// </summary>
        static readonly Lazy<ConcurrentDispatcherQueue> _instance = new(() => new ConcurrentDispatcherQueue(), true);
        ...
        /// </summary>
        public static ConcurrentDispatcherQueue Instance
        {
            get
            {
