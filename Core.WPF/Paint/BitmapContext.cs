...
namespace Imagin.Core.Media
{
    ...
    public unsafe struct BitmapContext : IDisposable
    {
        ...
        public BitmapContext(WriteableBitmap writeableBitmap, ReadWriteMode mode)
        {
            ...
            //{
            //   throw new ArgumentException("The input WriteableBitmap needs to have the Pbgra32 pixel format. Use the XBitmap.ConvertToPbgra32Format method to automatically convert any input BitmapSource to the right format accepted by this class.", "writeableBitmap");
            //}
            ...
            { 
                ...
                double width = _backBufferStride / XBitmap.SizeOfArgb;
