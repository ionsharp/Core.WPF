...
float X0 : register(C4);
float Y0 : register(C5);
float Z0 : register(C6);

float X1 : register(C7);
float Y1 : register(C8);
float Z1 : register(C9);

float X2 : register(C10);
float Y2 : register(C11);
float Z2 : register(C12);
