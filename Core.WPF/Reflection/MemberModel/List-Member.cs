...
namespace Imagin.Core.Reflection
{
    public abstract class ListMemberModel : MemberModel
    {
        ...
        public ObservableCollection<ListObjectModel> Items { get; private set; } = new();
        ...
        public ListMemberModel(MemberData data, int depthIndex) : base(data, depthIndex) { }
        ...
        {
            ListObjectModel result = new(this, new(Parent, new(new MemberPathSource(i)), null, new(null)));
            if (index == -1)
                Items.Add(result);
