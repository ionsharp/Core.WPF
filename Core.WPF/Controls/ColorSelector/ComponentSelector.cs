...
{
    public static readonly DependencyProperty DimensionProperty = DependencyProperty.Register(nameof(Dimension), typeof(Dimensions), typeof(ComponentSelector), new FrameworkPropertyMetadata(Dimensions.Two));
    public Dimensions Dimension
    {
        get => (Dimensions)GetValue(DimensionProperty);
    ...
    public static readonly DependencyProperty ShapeProperty = DependencyProperty.Register(nameof(Shape), typeof(Shapes2), typeof(ComponentSelector), new FrameworkPropertyMetadata(Shapes2.Square));
    ...
    protected virtual void OnZChanged(Value<One> input) => Mark();
}
