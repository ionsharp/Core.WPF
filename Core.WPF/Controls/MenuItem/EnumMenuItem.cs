...
public class EnumMenuItem : MenuItem
{
    ...
    static void OnTypeChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e) => sender.As<EnumMenuItem>().OnTypeChanged(e.Convert<Type>());
    ...
    static void OnTypeVisibilityChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e) => sender.As<EnumMenuItem>().OnTypeVisibilityChanged(e.Convert<Appearance>());
    ...
    static void OnValueChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e) => sender.As<EnumMenuItem>().OnValueChanged(e.Convert<Enum>());
    ...
    protected virtual void OnTypeChanged(ReadOnlyValue<Type> input)
        => Update();

    protected virtual void OnTypeVisibilityChanged(ReadOnlyValue<Appearance> input)
        => Update();
    ...
    protected virtual void OnValueChanged(ReadOnlyValue<Enum> input)
