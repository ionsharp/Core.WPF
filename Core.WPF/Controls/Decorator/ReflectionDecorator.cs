...
public class ReflectionDecorator : Decorator
{
    ...
    public ReflectionDecorator()
    {
        ...
        _opacityMask.GradientStops.Add(new GradientStop(System.Windows.Media.Colors.Black, 0));
        _opacityMask.GradientStops.Add(new GradientStop(System.Windows.Media.Colors.Black, 0.5));
        _opacityMask.GradientStops.Add(new GradientStop(System.Windows.Media.Colors.Transparent, 0.8));
        _opacityMask.GradientStops.Add(new GradientStop(System.Windows.Media.Colors.Transparent, 1));
