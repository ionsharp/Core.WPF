...
public abstract class UpDown<T> : UpDown, IUpDown<T>
{
    ...
    static void OnMaximumChanged(DependencyObject i, DependencyPropertyChangedEventArgs e) => i.As<UpDown<T>>().OnMaximumChanged(e.Convert<T>());
    ...
    static void OnMinimumChanged(DependencyObject i, DependencyPropertyChangedEventArgs e) => i.As<UpDown<T>>().OnMinimumChanged(e.Convert<T>());
    ...
    static void OnValueChanged(DependencyObject i, DependencyPropertyChangedEventArgs e) => i.As<UpDown<T>>().OnValueChanged(e.Convert<T>());
    ...
    public UpDown() : base()
    {
        ...
        OnValueChanged(new ReadOnlyValue<T>(Value));
    }
    ...
    protected virtual void OnMaximumChanged(ReadOnlyValue<T> input) { }

    protected virtual void OnMinimumChanged(ReadOnlyValue<T> input) { }

    protected virtual void OnValueChanged(ReadOnlyValue<T> input) => handle.SafeInvoke(() => SetText(ToString(input.New)));
