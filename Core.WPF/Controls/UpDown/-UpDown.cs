...
public abstract class UpDown : TextBox
{
    ...
    static void OnMajorChangeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) => d.As<UpDown>().OnMajorChangeChanged(e.Convert<double>());
    ...
    protected virtual void OnMajorChangeChanged(ReadOnlyValue<double> input)
    {
        ResetTimer();
    }
