...
namespace Imagin.Core.Controls
{
    public class DoubleUpDown : NumericUpDown<double>
    {
        ...
        protected override object OnMaximumCoerced(object input) => input.As<double>().Clamp(AbsoluteMaximum, Value);

        protected override object OnMinimumCoerced(object input) => input.As<double>().Clamp(Value, AbsoluteMinimum);

        protected override object OnValueCoerced(object input) => input.As<double>().Clamp(Maximum, Minimum);
